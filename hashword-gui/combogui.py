...
class Frame(wx.Frame):
    def __init__(self, parent, title):
        ...
        self.btnS = wx.Button(self.panel, -1, "Press here for short mode")
        self.Bind(wx.EVT_BUTTON, self.GetShort, self.btnS)
        self.btnL = wx.Button(self.panel, -1, "Press here for long mode")
        self.Bind(wx.EVT_BUTTON, self.GetLong, self.btnL)
    ...
    def GetShort(self, e):
        dlg = NameDialog(self)
        dlg.ShowModal()
        self.txt.SetValue("#" + hashlib.sha256(dlg.result).hexdigest())
...
app = wx.App()
frame = Frame(None, 'Hashword Generator')
app.MainLoop()
