...
import hashlib # Import hashlib for sha2/md5 functionality.
...
class SeedDialog(wx.Dialog):
    def __init__(self, parent, id=-1, title="hashword"):
        wx.Dialog.__init__(self, parent, id, title, size=(-1, 235))
        ...
        self.field = wx.TextCtrl(self, value="", size=(300, 20), style=wx.TE_PROCESS_ENTER) # Define field TextCtrl element
        ...
        self.mainSizer.Add(self.buttonSizer, 0, wx.ALL, 8) # Add buttonSizer to mainSizer
...
class Frame(wx.Frame):
    def __init__(self, parent, title):
        wx.Frame.__init__(self, parent, title=title, size=(320, 120))
        ...
        self.txt = wx.TextCtrl(self.panel, -1, size=(300, 20)) # define txt as a TxtCtrl element
...
# Define core function
    def GetShort(self, e):
        ...
        self.txt.SetValue("#" + hashlib.md5(dlg.result).hexdigest()) # set the value of txt as a hash symbol followed by the md5 hash of the result of what was input into SeedDialog
    def GetLong(self, e):
		dlg = SeedDialog(self) # set dlg as SeedDialog
		dlg.ShowModal() # Show dialog when the OK from SeedDialog is used
